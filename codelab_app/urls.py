...
from codelab_app.views import custom_page_not_found_view # views-da funksiya bolmaly

handler404 = 'codelab_app.views.custom_page_not_found_view'
...
urlpatterns = [
    ...
    # ... your existing urls ...
    path('chapter/<slug:category_slug>/<slug:chapter_slug>/', views.chapter_detail, name='chapter_detail'), # Assuming this exists
